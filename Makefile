...
# konveyor.io/mtk-operator-bundle:$VERSION and konveyor.io/mtk-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= konveyor.io/mtk-operator
...
.PHONY: clustertasks
clustertasks:
	mkdir -p deploy/artifacts/ && touch deploy/artifacts/clustertasks.yaml | $(KUSTOMIZE) build $(CLUSTERTASK_SOURCE) > deploy/artifacts/clustertasks.yaml
